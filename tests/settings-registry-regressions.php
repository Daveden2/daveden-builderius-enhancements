...
$native_feature_ids = array( 'auto_bem', 'dblclick_rename', 'inline_rename', 'preview_resize', 'undo_delete' );
...
foreach ( array( 'context_menu', 'css_code_default', 'favourites_reorder', 'keyboard_shortcuts', 'scope_bar' ) as $feature_id ) {
	dbe_settings_test_assert(
		! dbe_feature_replaced_by_builderius_for_version( $feature_id, '1.3.6-beta' ),
