    ...
    function onContextMenuShow() {
        dbeSetOwnedFrame(DBE_COMMANDS_OWNER, function () {
            ...
            if (menuEl) {
                ...
                var ctxModForLabel = lastCtxId && ctxModsForLabel[lastCtxId];
                var ctxTargetLabel = ctxModForLabel && (ctxModForLabel.label || defaultLabelFor(lastCtxId));
    ...
    if (typeof dbeWorkspaceChunk === 'function') {
        dbeWorkspaceChunk(Object.freeze({
            ...
            canvas: Object.freeze({
                interactive: dbeCanvasInteractive,
                setInteractive: dbeSetCanvasInteractive
            }),
            controllers: dbeControllers,
            observe: dbeObserveChrome,
            observeFooter: dbeObserveFooter,
