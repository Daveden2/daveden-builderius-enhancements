(function () {
    ...
    chunks.a11yComposites = function (host) {
        ...
        var decorateTree = host.decorateTree;
        var dbeRestoreTreeDecorations = host.restoreTreeDecorations;
        var bindMultiSelect = host.bindMultiSelect;
        var bindMultiDrag = host.bindMultiDrag;
        var ensureNavKeyboard = host.ensureNavKeyboard;
        var ensureFavouritesReorder = host.ensureFavouritesReorder;
        var applyFavouritesOrder = host.applyFavouritesOrder;
        var dbeResetFavouritesReorder = host.resetFavouritesReorder;
