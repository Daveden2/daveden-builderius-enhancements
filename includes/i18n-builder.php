...
function dbe_builder_strings() {
	return array(
		...
		'editAsHtmlHint'                => __( 'Existing IDs preserve matching module settings. Components use <dbe-component> and unsupported modules use <dbe-keep>. Review kept, added, removed and sanitised items before applying.', 'daveden-builderius-enhancements' ),
