...
function dbe_features() {
	return array(
		...
		'css_code_default'    => array(
			...
			'description' => __( 'Opens the Styles tab straight into the CSS code editor, keeps the Content and Styles tabs visible while you are there, and adds a button to widen the panel when you need more room.', 'daveden-builderius-enhancements' ),
			'tab'         => 'styles',
		...
		'scope_bar'           => array(
			...
			'description' => __( 'Shows where your CSS edits will be saved (local, global or template) and adds an instant Global/Template switch, directly in the Styles code editor.', 'daveden-builderius-enhancements' ),
			'tab'         => 'styles',
